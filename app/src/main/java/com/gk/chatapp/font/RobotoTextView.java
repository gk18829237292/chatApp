...
public class RobotoTextView extends TextView {
    ...
    public static Typeface getRoboto(Context context, int typeface) {
        switch (typeface) {
            ...
            case Roboto.ROBOTO_GK:
                if(Roboto.sRobotoGk == null){
                    Roboto.sRobotoGk = Typeface.createFromAsset(context.getAssets(), "fonts/in.ttf");
                }
                return Roboto.sRobotoGk;
        }
    }
    ...
    public static class Roboto {
        ...
        */
        ...
        public static final int ROBOTO_GK = 16;
        ...
        private static Typeface sRobotoGk;
    }
}
