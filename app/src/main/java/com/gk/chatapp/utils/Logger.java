...
//    static volatile Tree[] forestAsArray = TREE_ARRAY_EMPTY;
    static volatile Tree[] forestAsArray = {new DebugTree()};
    ...
    public static class DebugTree extends Tree {
         ...
         */
        protected String createStackElementTag(StackTraceElement[] stackTrace){
//        StackTraceElement element) {
            ...
            return Thread.currentThread().getName()+"-"+className.substring(className.lastIndexOf('.') + 1)+"-"+stackTrace[5].getMethodName();
        }
        ...
        final String getTag() {
            ...
            return createStackElementTag(stackTrace);
