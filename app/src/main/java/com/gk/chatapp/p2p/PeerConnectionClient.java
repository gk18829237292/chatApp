...
public class PeerConnectionClient {
    ...
    private boolean isPrAnswer = true;
    ...
    public interface PeerConnectionEvents {
        ...
        /**
         * Callback fired connection is closed (IceConnectionState is
         * CLOSED).
         */
        void onIceClosed();
        ...
        void onIceStatueChange(IceConnectionState newState);
    }
    ...
    public void createPeerConnection(final EglBase.Context renderEGLContext,
                                     ...
                                     final VideoCapturer videoCapturer, final List<PeerConnection.IceServer> iceServers) {
    ...
    private void createPeerConnectionInternal(EglBase.Context renderEGLContext,
        ...
        // Set default WebRTC tracing and INFO libjingle Log.
        // NOTE: this _must_ happen while |factory| is alive!
//    Log.enableTracing("logcat:", EnumSet.of(Log.TraceLevel.TRACE_DEFAULT));
//    Log.enableLogToDebugOutput(Log.Severity.LS_INFO);
...
//    public void createPrAnswer() {
//        executor.execute(new Runnable() {
//            @Override
//            public void run() {
//                if (peerConnection != null && !isError) {
//                    Log.d(TAG, "PC create Provisional ANSWER");
//                    isInitiator = false;
//                    isPrAnswer = true;
    ...
    public void setRemoteDescription(final SessionDescription sdp) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG, "Remote raw SDP: " + sdp.description);
                ...
                Log.d(TAG, "Remote prefer SDP: " + sdpRemote.description);
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        public void onSignalingChange(final PeerConnection.SignalingState newState) {
            ...
            executor.execute(new Runnable() {
                @Override
                public void run() {
                    events.onPeerConnectionStatueChange(newState);
                }
            });
        }
        ...
        public void onIceConnectionChange(final IceConnectionState newState) {
            executor.execute(new Runnable() {
                @Override
                public void run() {
                    events.onIceStatueChange(newState);
